...
Additionally, the library size of the Negative group looks similar to that of other groups, indicating that they may be misclassified as Negative due to their tagging quality rather than overall RNA quality.
...
new_vcf
````
The subsetted .vcf can be written as follows, again from [VariantAnnotation](https://bioconductor.org/packages/release/bioc/html/VariantAnnotation.html) package.
