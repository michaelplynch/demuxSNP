...
Heatmap(counts(altExp(sce,"SNP")),cluster_column_slices = FALSE,cluster_rows = FALSE,column_split=sce$seurat,show_row_names = FALSE,show_column_names = FALSE,col=colors)
